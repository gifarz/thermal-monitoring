import { panelButtonCoordinate } from "./coordinateMatindok";
import { menuButton } from "./coordinates";

export const menuButtonMatindok = (ctx, canvasWidth, canvasHeight) => {
    // Draw buttons
...
export const panelButtonMatindok = (ctx, canvasWidth, canvasHeight) => {
    // Draw Panel
...
export const boundClickMatindok = (x, y, router) => {
...
export const boundHoverMatindok = (x, y, canvas) => {
